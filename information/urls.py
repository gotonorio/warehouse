...
urlpatterns = [
    ...
    # 情報の修正
    path('info_update/<int:pk>',
         views.InformationUpdateView.as_view(), name='info_update'),
    # 情報の削除
    path('info_delete/<int:pk>',
         views.InformationDeleteView.as_view(), name='info_delete'),
]
