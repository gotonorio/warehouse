    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alive', models.BooleanField(default=True, verbose_name='有効')),
                ('parent', models.ForeignKey(default=1, on_delete=django.db.models.deletion.PROTECT, to='library.bigcategory', verbose_name='親カテゴリ')),
            ],
        ),
        migrations.CreateModel(
            name='File',
            fields=[
                ...
                ('key_word', models.TextField(blank=True, null=True, verbose_name='キーワード')),
                ...
                ('category', models.ForeignKey(default=1, on_delete=django.db.models.deletion.PROTECT, to='library.category', verbose_name='カテゴリ')),
            ],
        ),
    ]
