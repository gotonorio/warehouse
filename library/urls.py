...
urlpatterns = [
    ...
    path(
        "file/category/<int:category_pk>",
        views.FileCategoryView.as_view(),
        name="file_category",
    ),
    ...
    path(
        "category/bigcategory/<int:big_pk>",
        views.CategoryBigView.as_view(),
        name="category_big",
    ),
    path(
    ...
    # BigCategoryのCRUD
    path(
        "big_category/", views.BigCategoryIndexView.as_view(), name="big_category_index"
    ),
    path(
        "big_category/create/",
        views.BigCategoryCreateView.as_view(),
        name="big_category_create",
    ),
    path(
        "big_category/update/<int:pk>",
        views.BigCategoryUpdateView.as_view(),
        name="big_category_update",
    ),
    path(
        "big_category/delete/<int:pk>",
        views.BigCategoryDeleteView.as_view(),
        name="big_category_delete",
    ),
