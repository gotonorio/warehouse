...
urlpatterns = [
    ...
    path(
        "room/update/<int:pk>", data_views.RoomUpdateView.as_view(), name="room_update"
    ),
    path(
        "room/import_parking",
        data_views.ImportParkingfee.as_view(),
        name="import_parkingfee",
    ),
    path(
        "room/import_bicycle",
        data_views.ImportBicyclefee.as_view(),
        name="import_bicyclefee",
    ),
]
